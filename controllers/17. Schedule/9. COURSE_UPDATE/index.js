...
const COURSE_UPDATE_SCHEDULE = async (req, res) => {
  try {
    const user = req.user;
    const { id } = req.params
    ...
    const { category, teacher , schedule_date, start_time, end_time, location, note } = req.body;
...
module.exports = COURSE_UPDATE_SCHEDULE
