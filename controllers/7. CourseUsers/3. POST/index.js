...
const POST_COURSE_USERS = async (req , res) => {
    try 
    {
        const { course, firstname, lastname, register, phone, kode, password, confirmPassword, birthdate } = req.body;
...
module.exports = POST_COURSE_USERS